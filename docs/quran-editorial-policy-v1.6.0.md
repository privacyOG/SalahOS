...
This registry is a translation-risk audit, not a claim that these 122 verses exhaust every theological category of mutashabih. The supplied guide separately notes matters whose exact realities or times are known only to Allah.
...
Software validation still verifies all 114 surahs / 6,236 ayat, content identity, Arabic provenance and the 122-trigger parity contract. The prior project-owner whole-corpus attestation is retained as release/editorial provenance, not independent scholarly approval.
