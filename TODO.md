...
**Stage 23.11 verification note (2026-08-23):** PR #185 code-bearing head `53b9f04ee6f160eb9d71a7440e44a6d50f5744d5` passed Quality Gate `32604176420`, Android Build `32604176462`, Visual Regression `32604176399` and iOS Build `32604176432`. Optional weather is disabled by default, requires both an enabled presentation module and an explicitly configured fixed-location feed, never reads browser/native GPS or the prayer-calculation location, and sends only the coordinates entered for weather to the reviewed Open-Meteo adapter. The module persists a bounded two-hour last-known-good cache, fails soft on provider/network errors and hides expired/unavailable weather without affecting local prayer information. Exact Visual artifact `9483707774` (SHA-256 `5b6f00dab07141f6ddaa5c1199d413ac4c19f88c3add0a5718791fc48debc941`) received human review: TV/Kiosk ready and provider-failure/cache states preserved the complete five-prayer board, expired weather hid cleanly, and Phone/Home settings plus rendered weather remained readable with bottom navigation and all five prayer rows intact. Stage 23.11 is complete.
...
- [x] Continue phone, tablet and desktop responsive refinement
- [x] Complete Raspberry Pi Touch Display 2 close-range UX refinement
- [x] Complete 1080p/4K TV and kiosk refinement for all required prayer-board templates

**Stage 25 verification note (2026-08-23):** PR #190 code-bearing head `10c5c0d9a7416241c2616104fb24a82ebda98d14` passed Quality Gate `32635064665`, Visual Regression `32635064617`, Android Build `32635064630` and iOS Build `32635064637`. Exact Visual artifact `9492111118` (`sha256:12cd2fd855545a3ab9f35d8bc76e0544349dd10dc7aa34548cfea4d699a029e4`) passed permanent phone acceptance at 320/390/430px including Arabic OS text scaling 1.25 and Turkish/Indonesian expansion, tablet/desktop hierarchy and controlled line lengths, 5/7/10-inch Touch Display close-range profiles with 44px recovery controls, all six TV templates at 1080p/4K safe regions, burn-in/reduced-motion and keyboard recovery. Human review confirmed prayer-card containment, scannable five-prayer tables, unobscured fixed navigation and long-distance TV readability. Stage 25 is complete.

---

## 26. Accessibility, RTL and visual acceptance

- [x] Continue accessibility, RTL and human visual acceptance across redesigned surfaces
- [x] Complete the full Stage 26 accessibility and internationalisation matrix
- [x] Complete screenshot and golden-state coverage for all redesigned application/display surfaces

**Stage 26 verification note (2026-08-23):** PR #190 code-bearing head `10c5c0d9a7416241c2616104fb24a82ebda98d14` passed Quality Gate `32635064665`, Visual Regression `32635064617`, Android Build `32635064630` and iOS Build `32635064637`. Exact Visual artifact `9492111118` (`sha256:12cd2fd855545a3ab9f35d8bc76e0544349dd10dc7aa34548cfea4d699a029e4`) passed WCAG AA application/display contrast including Sandstone muted text at 4.62:1, semantic landmarks/headings, accessible names, visible keyboard focus, textual current/next prayer state, reduced-motion, forced-colours, Arabic/RTL across all redesigned congregation destinations and all six prayer-board templates at 1080p/4K, mixed-direction isolation, Turkish/Indonesian expansion, administration pages, Touch Display portrait/landscape and golden current/next, unavailable/stale, Jumu'ah and Ramadan fixtures. Human review covered light/dark congregation surfaces, Arabic/RTL, administration, forced-colours, Touch Display, responsive phone cases and all 12 Arabic prayer-board renders; hierarchy and readability were clean and no template appeared to be a direct third-party visual copy. Stage 26 is complete.

---

## 27. Legacy UI retirement and migration completion

- [x] Remove legacy destination-hiding and superseded global CSS only after all consumers migrate
- [x] Run the complete cross-platform regression suite after legacy retirement
- [x] Update final design-system/platform documentation and screenshots
- [x] Mark UI/UX v2 complete only after automated and human acceptance are complete

**Stage 27 verification note (2026-08-23):** PR #191 code-bearing head `bfef1935402d17ffec88310259ba111d59f763ab` passed Quality Gate `32642038448`, Visual Regression `32642038440`, Android Build `32642038441` and iOS Build `32642038443`, including fresh iPhone and iPad Simulator install, launch and relaunch acceptance. The migration retires the legacy single-page Settings/App composition, portal/MutationObserver injection, obsolete destination-hiding CSS and root compatibility token aliases; dedicated v2 Settings panels and `SmartDisplayApplication` now own those surfaces directly while administrator-only controls remain in the administration tree. Exact Visual artifact `9493898944` (`sha256:4a13035ba455d9ca6d7f9f873b64abb3b80437673aadee90bb4e7df85d840189`) passed the complete historical visual matrix plus Stage 27 direct Settings ownership and smart-display retirement checks. Human review accepted the migrated Location, Mosque, Notifications, Advanced and Display Themes routes, including restored direct Phone/Home weather configuration, the isolated 1080p smart display, Arabic/RTL and administration spot checks. UI/UX v2 is complete.
