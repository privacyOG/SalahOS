...
describe('Qur’an Muhkam/Mutashabih editorial register', () => {
  it('contains all four foundations and all 131 maintained translation-risk verses', () => {
    ...
    expect(expectedTriggered).toHaveLength(131);
    expect(register.entries).toHaveLength(135);
