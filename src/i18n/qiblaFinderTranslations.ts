...
export const qiblaFinderCopy = {
  en: {
    ...
    privacy:
      'Location and Qiblah calculations stay on this device unless you choose to load map tiles.',
    compassView: 'Compass',
    mapView: 'Map',
    ...
    locationDenied:
      'Location permission was denied. Retry after enabling permission or use a manual location.',
    ...
    compassUnavailable:
      'This device has no usable compass sensor. Use the true-north bearing or map instead.',
    ...
    calibrationBody:
      'Move the device in a figure-8. Keep it away from metal, magnetic tablet covers and keyboard cases.',
    mapPrivacyTitle: 'Map tiles use OpenStreetMap',
    mapPrivacyBody:
      'Loading the map requests tiles from OpenStreetMap and sends normal network metadata. If centred on your location, the viewed area can reveal your approximate location. SalahOS does not attach your saved prayer settings or mosque data.',
  ...
  ar: {
    ...
    calibrationBody:
      'حرّك الجهاز على شكل رقم 8 وأبعده عن المعادن والأغطية المغناطيسية ولوحات المفاتيح المغناطيسية.',
    mapPrivacyTitle: 'تستخدم الخريطة OpenStreetMap',
    mapPrivacyBody:
      'عند تحميل الخريطة تُطلب المربعات من OpenStreetMap وتُرسل بيانات الشبكة المعتادة. إذا كانت الخريطة متمركزة على موقعك فقد تكشف منطقة العرض موقعك التقريبي. لا يرفق صلاح أو إس إعدادات الصلاة المحفوظة أو بيانات المسجد.',
  ...
  tr: {
    ...
    privacy:
      'Harita döşemelerini yüklemeyi seçmediğiniz sürece konum ve kıble hesapları bu cihazda kalır.',
    compassView: 'Pusula',
    mapView: 'Harita',
    ...
    locationDenied:
      'Konum izni reddedildi. İzni açtıktan sonra yeniden deneyin veya manuel konum kullanın.',
    locationUnavailable:
      'Konumunuz alınamıyor. Yeniden deneyin veya şehir ya da harita iğnesi kullanın.',
    ...
    calibrationBody:
      'Cihazı 8 şekli çizerek hareket ettirin. Metalden, manyetik tablet kapaklarından ve klavye kılıflarından uzak tutun.',
    mapPrivacyTitle: 'Harita döşemeleri OpenStreetMap kullanır',
    mapPrivacyBody:
      'Harita yüklendiğinde döşemeler OpenStreetMap’den istenir ve olağan ağ meta verileri gönderilir. Harita konumunuza ortalanmışsa görüntülenen alan yaklaşık konumunuzu açığa çıkarabilir. SalahOS kayıtlı namaz ayarlarınızı veya cami verilerinizi eklemez.',
  ...
  id: {
    ...
    privacy:
      'Lokasi dan perhitungan kiblat tetap di perangkat ini kecuali Anda memilih memuat ubin peta.',
    compassView: 'Kompas',
    mapView: 'Peta',
    ...
    compassUnavailable:
      'Perangkat ini tidak memiliki sensor kompas yang dapat digunakan. Gunakan arah utara sejati atau peta.',
    ...
    calibrationBody:
      'Gerakkan perangkat membentuk angka 8. Jauhkan dari logam, penutup tablet magnetik, dan casing papan ketik.',
    mapPrivacyTitle: 'Ubin peta menggunakan OpenStreetMap',
    mapPrivacyBody:
      'Saat peta dimuat, ubin diminta dari OpenStreetMap dan metadata jaringan normal dikirim. Jika peta dipusatkan pada lokasi Anda, area yang dilihat dapat mengungkap perkiraan lokasi Anda. SalahOS tidak menyertakan pengaturan salat tersimpan atau data masjid Anda.',
