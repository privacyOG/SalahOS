...
- Reconcile the Ashʿarī–Māturīdī tanzīh audit to 143 maintained translation-risk verses, including the required ru’yah pair 6:103 and 75:23 and the later need/dependency/transaction idiom pass, give every trigger explicit SalahOS 2026 wording, populate a 147-row pending review register (143 triggers + four foundations), and fail release refs closed until independent qualified scholarly review is approved.
