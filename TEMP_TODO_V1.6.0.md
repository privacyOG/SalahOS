...
- [x] Q06 Required guide seeds remain regression fixtures; the reconciled 110-verse trigger registry gives every maintained translation-risk verse explicit SalahOS 2026 wording without global lexical replacement.
...
- [x] Q10 Release gate verifies complete corpus, all 110 trigger treatments, identity/provenance and owner attestation, and now fails closed on release refs until independent qualified scholarly review is approved.
...
- The verse-level review register now contains all 110 maintained translation-risk verses plus four governing foundations, all explicitly pending qualified scholarly review with no synthetic reviewer.
