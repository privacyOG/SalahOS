...
- [x] A01 Clear rejected loader promises; Retry after HTTP, network and malformed-pack failures without deleting bookmarks or last-read state.
  - Evidence: PR #269 merged the validated retry/recovery path and focused rejected-promise tests; the exact V1.6.0 candidate head `4e64cdd1621118854358f6258bf647f506218b5a` subsequently passed Quality, Visual, Android, iOS and Windows.
- [x] A02 Explicit PWA offline preparation verifies reader assets, corpus and font; distinguish preparing, ready, unavailable and native bundled states.
  - Evidence: `quranOfflinePreparation` verifies Cache API availability, corpus/font/hash and exposes preparing/ready/unavailable/native-bundled states with prepared, unavailable and interrupted-load tests; the exact V1.6.0 candidate passed all five permanent workflows.
- [x] A03 Verify complete corpus/font in production and native bundles; test clean native offline, prepared/unprepared PWA and interrupted loads.
  - Evidence: PR #270 added installed Android airplane-mode Qur’an/font transport acceptance; Android/iOS native bundle checks verify the packaged corpus/font and PWA tests cover prepared, unavailable and interrupted preparation. PR #277 then passed Android lifecycle and fresh iPhone/iPad Simulator acceptance on exact head `4e64cdd1621118854358f6258bf647f506218b5a`.
...
- [x] K01 Distinct Quran / Hadith / Fiqh & questions scopes, remove duplicate filters, report scoped collection/result counts.
  - Evidence: Knowledge exposes the three distinct scopes, confines Fiqh/Questions filtering to the relevant library, and renders scoped collection/result counts; integrated Quality/Visual acceptance passed on the exact V1.6.0 candidate.
...
- [x] K03 Label English content and selected commentary honestly with explicit language/direction.
  - Evidence: PR #267 added explicit English rendering/answer labels and `lang`/`dir` treatment while keeping translation distinct from commentary/summary content; permanent validation passed after merge and on the V1.6.0 candidate.
- [x] K04 Rename abbreviated Isnad to Companion narrator; preserve sourced grading and school distinctions.
  - Evidence: the Hadith metadata label is Companion narrator without altering grading/madhhab data; integrated Quality and Visual acceptance passed on the V1.6.0 candidate.
...
- [x] Q01 Encode supplied Muhkam/Mutashabih guide; foundations 42:11, 112:4, 19:65 and method 3:7; prohibit bodily/spatial implications for Allah.
  - Evidence: `docs/quran-editorial-policy-v1.6.0.md` encodes the supplied guide, governing/foundation verses and explicit prohibition on bodily/spatial implications; policy tests passed in the exact V1.6.0 candidate Quality gate.
...
- [x] Q08 Verify full Uthmani corpus/source/reading/edition/licence/hash; preserve canonical marks and separate normalized search.
  - Evidence: PR #275 exact head `e06bed052da528db99fb50c50e0c02d3a4ed720a` documented Tanzil Uthmani / Medina Mushaf / Hafs provenance and the dataset/upstream licence boundary, preserved canonical corpus bytes, added search-only Arabic normalization and passed Quality, Visual, Android, iOS and Windows before merge as `3c9ef00e9ef266697a0180d4c0cbdf153a3eb090`.
...
- [ ] Q10 Regression gates, explicit complete coverage report and named scholarly sign-off; no unresolved policy violations before release.
  - Blocker: named qualified whole-corpus sign-off is not complete. Automated tooling must not populate or infer approval.
...
- [x] R01 Update Instructions guide, CHANGELOG and V1.6.0 release notes with verified behavior and limitations.
  - Evidence: PR #277 updated all three documents, including physical-device/scholarly release boundaries and Uthmani provenance, and passed the complete permanent workflow matrix before merge as `dad403e14443404779628b29cbaf8061538fee10`.
- [x] R02 Synchronize npm/lock/Android/iOS versions to 1.6.0 and advance native build numbers together.
  - Evidence: PR #277 exact head `4e64cdd1621118854358f6258bf647f506218b5a` synchronized npm/package-lock to `1.6.0`, Android to versionCode `11` / versionName `1.6.0`, and iOS to build `11` / marketing version `1.6.0`; all five permanent workflows passed.
- [x] R03 Pass formatting, lint, typecheck, tests/coverage, content/integrity, security, design-token checks, production build and bundle limits.
  - Evidence: Quality Gate run 2856 passed every required step on exact V1.6.0 candidate head `4e64cdd1621118854358f6258bf647f506218b5a`, including corpus/content integrity, security, tests/coverage, production build, bundle budget and deploy-artifact verification.
- [ ] R04 Pass permanent Quality, Visual, Android, iOS and Windows workflows on exact release revision/current main; preserve branch protections.
  - Evidence to date: all five passed on the V1.6.0 candidate, but this release-specific item remains open until the final accepted revision is exact current `main`.
...
- Integrated V1.6.0 candidate evidence: PR #277 exact head `4e64cdd1621118854358f6258bf647f506218b5a` contained all merged product work through Q08 and passed permanent Quality, Visual, Android, iOS and Windows workflows before merge as `dad403e14443404779628b29cbaf8061538fee10`.
