...
- [x] Q06 Required guide seeds remain regression fixtures; the reconciled 143-verse trigger registry gives every maintained translation-risk verse explicit SalahOS 2026 wording without global lexical replacement.
...
- [x] Q10 Release gate verifies complete corpus, all 143 trigger treatments, identity/provenance and owner attestation, and now fails closed on release refs until independent qualified scholarly review is approved.
...
- The verse-level review register now contains all 143 maintained translation-risk verses plus four governing foundations, all explicitly pending qualified scholarly review with no synthetic reviewer.
...
- Stable publication requires the exact-main workflow matrix, release signing/archive integrity, published-asset checksum verification **and approved independent qualified scholarly review**. A later exact-version project-owner authorization may permit a clearly labelled prerelease while qualified review remains pending; such authorization is not scholarly approval and may not change pending review rows.
