...
assert(
  salahos2026?.translationId === 'salahos-2026',
  'SalahOS 2026 translation identity is missing.',
);
assert(
...
for (const seed of register.requiredSeedVerses ?? []) {
  ...
  assert(
    ...
    `${seed} is not marked Mutashabih in SalahOS 2026.`,
  );
...
console.log(
  'Qur’an editorial release gate passed for the complete 6,236-ayah SalahOS 2026 corpus.',
);
