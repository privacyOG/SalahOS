...
describe('release asset workflow', () => {
  ...
  it('requires persistent Android signing before creating release APK and AAB packages', () => {
    ...
    expect(workflow).toContain('Unable to resolve signed APK certificate SHA-256 fingerprint');
    expect(workflow).toContain('Unable to resolve signed AAB certificate SHA-256 fingerprint');
    expect(workflow).toContain(
