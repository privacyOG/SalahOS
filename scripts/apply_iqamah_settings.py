...
text = replace_once(
    text,
    "    manualMosqueDayError:\n      'أدخل اسم المسجد وتاريخاً صالحاً وأوقات بداية الصلوات الخمس بصيغة 24 ساعة.',\n",
    "    manualMosqueDayError:\n      'أدخل اسم المسجد وتاريخاً صالحاً وأوقات بداية الصلوات الخمس وإعدادات إقامة صالحة.',\n",
)
path.write_text(text)
